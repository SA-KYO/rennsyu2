...
const IMAGES = {
  mainVisual: "/images/e9-80-8f-e9-81-8e-e3-83-ad-e3-82-b3-e3-82-99.png",
  ramenBowl: "/images/544631226-17863923576461658-4117409213048558982-n.jpg",
  chashu: "/images/unnamed-20-281-29.webp",
  beer: "/glass-of-draft-beer.jpg",
  menu1: "/images/556574845-17866044354461658-2379283613806424986-n.jpg",
  menu2: "/images/544631226-17863923576461658-4117409213048558982-n.jpg",
  menu3: "/images/unnamed-20-281-29.webp",
  menu4: "/images/544631226-17863923576461658-4117409213048558982-n.jpg",
  menu5: "/images/unnamed-20-281-29.webp",
  menu6: "/images/556574845-17866044354461658-2379283613806424986-n.jpg",
  noodle: "/images/556574845-17866044354461658-2379283613806424986-n.jpg",
  soup: "/images/561450091-1978633712677162-5145391547834510429-n.jpg",
  meat: "/images/unnamed-20-281-29.webp",
  ramenDon: "/images/544631226-17863923576461658-4117409213048558982-n.jpg",
  recruit1: "/images/unnamed-20-283-29.webp",
  recruit2: "/images/unnamed-20-282-29.webp",
  exterior: "/images/img-9559.jpeg",
  saltRamen: "/images/img-8742.png",
}
    ...
    <div className="min-h-screen bg-[#F5F0E8] text-[#1a1a1a] overflow-x-hidden font-sans">
      ...
      <section className="relative min-h-screen pt-20 flex items-center">
        ...
        <div className="relative max-w-4xl mx-auto px-4 z-10 w-full flex flex-col items-center justify-center">
          ...
          >
            <img
              src={IMAGES.mainVisual || "/placeholder.svg"}
              alt="麺屋 希楽夢"
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="space-y-4">
              <div className="rounded-2xl overflow-hidden">
                <img
                  src={IMAGES.exterior || "/placeholder.svg"}
                  alt="麺屋 希楽夢 外観"
...
function MenuSection() {
  ...
  const mainMenuItems = [
    {
      ...
      subtitle: "1番人気",
      description:
        "コシの強いオリジナルの細麺に、国産のガラや地元産野菜などをじっくり炊き上げたあっさりスープと、数種類の乾物、しじみに土佐のあまみ、海一粒、石垣の塩、モンゴル岩塩を合わせた塩ダレです。シンプルだけど奥深い、何度食べても飽きのこない塩らーめんです。",
      price: "1000円",
      image: IMAGES.saltRamen,
      label: "希楽夢の看板メニュー",
    ...
    },
    {
      ...
      subtitle: "おすすめ",
      description:
        "北海道産小麦粉を使用した自家製麺に、しじみ、昆布、煮干し、節類などの乾物を使った魚貝スープと鶏ガラ、丸鶏、野菜類を使った鶏スープのダブルスープ。埼玉県、奥出雲産、愛知産の醤油などをブレンドした醤油ダレで仕上げた一杯です。",
      price: "1000円",
    ...
    },
    {
      ...
      subtitle: "1日限定20食",
      description:
        "鶏白湯スープに煮干しを効かせたスープです。濃厚でありながらも煮干しの風味が効いた、きらむオリジナルの白湯らーめん。限定20食の人気メニューです。",
      price: "1050円",
      image: IMAGES.menu3,
      label: "1日限定20食",
      sideDish: null as string | null,
  ...
  return (
    <section id="menu" ref={sectionRef as any} className="relative overflow-hidden bg-[#D29D2B]">
          ...
          <div className="flex items-center flex-shrink-0">
            {[...Array(10)].map((_, i) => (
              <div key={`text-${i}`} className="inline-flex items-center mx-12">
                <span className="text-5xl md:text-7xl font-bold text-white tracking-widest font-serif-jp">KIRAMU</span>
              ...
              <div className="relative min-h-screen flex flex-col">
                ...
                <div className="flex-1 flex flex-col items-center justify-center px-8 pt-32 pb-16">
                  <div className="relative w-full max-w-md mx-auto mb-8">
                    <div className="absolute -top-6 -right-6 writing-vertical text-white font-bold text-7xl font-serif-jp opacity-10 z-0">
                      {item.title}
                    </div>
                    ...
                    {item.sideDish && (
                      <div className="absolute -bottom-8 -left-8 w-32 h-32 z-20">
                        <img
                          src={item.sideDish || "/placeholder.svg"}
                          alt="Side dish"
                  ...
                  <div className="text-center text-white space-y-4 max-w-lg">
                    <div className="relative inline-block">
                      <h3
                        className="text-4xl md:text-5xl font-bold tracking-wide leading-tight"
                        style={{ fontFamily: "'Noto Serif JP', serif" }}
                      >
                        {item.title}
                      </h3>
                      <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 w-32 h-1 bg-white/40" />
                    </div>
                    <p className="text-sm tracking-wider font-bold">{item.subtitle}</p>
                    {/* Added price display */}
                    {item.price && <p className="text-2xl font-bold text-[#FFE4B5]">{item.price}</p>}
                    <p className="leading-relaxed text-base md:text-lg opacity-90">{item.description}</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* トッピング・サイドメニュー */}
      {/* Added toppings and side menu section based on menu images */}
      <div className="bg-[#f5f1e8] py-16 px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center space-y-2">
              <h4 className="text-xl font-bold">特製盛り</h4>
              <p className="text-sm text-gray-600">バラチャーシュー2枚、肩ロース1枚、味玉、のり2枚増し</p>
              <p className="text-2xl font-bold text-[#c8102e]">400円</p>
            </div>
            <div className="text-center space-y-2">
              <h4 className="text-xl font-bold">味玉</h4>
              <p className="text-sm text-gray-600">城陽市の新鮮な玉子を使用</p>
              <p className="text-2xl font-bold text-[#c8102e]">150円</p>
            </div>
            <div className="text-center space-y-2">
              <h4 className="text-xl font-bold">メンマ増し</h4>
              <p className="text-sm text-gray-600">食感が楽しめる</p>
              <p className="text-2xl font-bold text-[#c8102e]">150円</p>
            </div>
            <div className="text-center space-y-2">
              <h4 className="text-xl font-bold">のり増し</h4>
              <p className="text-sm text-gray-600">香り豊かな海苔</p>
              <p className="text-2xl font-bold text-[#c8102e]">100円</p>
            </div>
          </div>

          <h3
            className="text-3xl md:text-4xl font-bold text-center mt-16 mb-12"
            style={{ fontFamily: "'Noto Serif JP', serif" }}
          >
            ご飯・ドリンク
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center space-y-2">
              <h4 className="text-xl font-bold">ご飯</h4>
              <div className="space-y-1">
                <p className="text-lg">
                  小 <span className="font-bold">100円</span>
                </p>
                <p className="text-lg">
                  中 <span className="font-bold">150円</span>
                </p>
                <p className="text-lg">
                  大 <span className="font-bold">200円</span>
                </p>
              </div>
            </div>
            <div className="text-center space-y-2">
              <h4 className="text-xl font-bold">チャーシュー丼</h4>
              <p className="text-sm text-gray-600">香ばしい炭火焼豚</p>
              <p className="text-2xl font-bold text-[#c8102e]">500円</p>
            </div>
            <div className="text-center space-y-2">
              <h4 className="text-xl font-bold">ビンビール</h4>
              <p className="text-2xl font-bold text-[#c8102e]">650円</p>
            </div>
            <div className="text-center space-y-2">
              <h4 className="text-xl font-bold">酎ハイ レモン</h4>
              <p className="text-2xl font-bold text-[#c8102e]">450円</p>
            </div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8 max-w-md mx-auto">
            <div className="text-center space-y-2">
              <h4 className="text-xl font-bold">コーラ</h4>
              <p className="text-2xl font-bold text-[#c8102e]">200円</p>
            </div>
            <div className="text-center space-y-2">
              <h4 className="text-xl font-bold">ラムネ</h4>
              <p className="text-2xl font-bold text-[#c8102e]">200円</p>
            </div>
          </div>
        </div>
...
function SignatureGallerySection() {
  ...
  return (
    <section id="gallery" className="py-24 px-4 bg-[#F5F0E8]">
      <div className="max-w-6xl mx-auto">
              ...
              <div className="relative flex-shrink-0">
                <div className="w-52 h-52 md:w-64 md:h-64 rounded-full bg-[#F5F0E8] flex items-center justify-center shadow-inner">
                  <div className="w-44 h-44 md:w-56 md:h-56 rounded-full overflow-hidden border-8 border-[#F5F0E8] shadow-xl">
                    <img
                      src={active.mainImage || "/placeholder.svg"}
                      alt={active.title}
                ...
                <div className="absolute -bottom-6 left-1/2 md:left-auto md:-right-6 translate-x-[-50%] md:translate-x-0">
                  <div className="flex items-center gap-2 md:gap-3 bg-white rounded-full shadow-md px-3 py-1.5">
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="text-xs font-semibold text-gray-800 whitespace-nowrap">{active.accentText}</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2">
                {items.map((_, i) => (
                  <button
                    key={i}
                    onClick={() => setIndex(i)}
                    className={`w-2 h-2 rounded-full transition-colors ${i === index ? "bg-[#C41E3A]" : "bg-gray-300"}`}
    ...
    <section id="recruit" className="py-24 px-4 bg-[#F5E6D3] relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto text-center relative z-10">
        ...
        <div className="flex justify-center gap-4 mb-12 flex-wrap">
          {[
            "/images/unnamed-20-283-29.webp",
            "/images/unnamed-20-282-29.webp",
            "/images/unnamed-20-283-29.webp",
            "/images/unnamed-20-282-29.webp",
          ].map((src, i) => (
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <img src={src || "/placeholder.svg"} alt={`店舗写真 ${i + 1}`} className="w-full h-full object-cover" />
            </motion.div>
          ))}
        </div>
